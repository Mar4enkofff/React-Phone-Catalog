  ...
  return (
    <section className="product-info">
      <div className="product-info__about" data-cy="productDescription">
        <h2 className="product-info__title product-info__title-about">About</h2>
        {details.description.map(({ text, title }) => {
          return (
            <div key={title} className="product-info__description">
      ...
      <div className="product-info__tech-specs">
        ...
        <ul className="product-info__tech-list">
          ...
          <li className="product-info__tech-item">
            ...
            <div className="product-info__tech-item-value">{details.ram}</div>
          </li>
          <li className="product-info__tech-item">
          ...
          <li className="product-info__tech-item">
            ...
            <div className="product-info__tech-item-value">{details.zoom}</div>
          </li>
          <li className="product-info__tech-item">
