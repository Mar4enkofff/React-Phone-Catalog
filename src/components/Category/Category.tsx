      ...
      >
        <Link className="category__link category__phones" to="/phones">
          ...
          <div className="category__info">
            <h3 className="category__title-small">Mobile phones</h3>
            <p className="category__quantity">{`${quantityPhones} models`}</p>
          </div>
        </Link>
        <Link className="category__link category__tablets" to="/tablets">
          ...
          <div className="category__info">
            <h3 className="category__title-small">Tablets</h3>
            <p className="category__quantity">{`${quantityTablets} models`}</p>
          </div>
        </Link>
        <Link
        ...
        >
          ...
          <div className="category__info">
            <h3 className="category__title-small">Accessories</h3>
